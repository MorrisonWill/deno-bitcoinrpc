...
export default class BitcoinRPC {
  ...
  async getblockstats(
    hash_or_height: number | string,
    stats?: Array<{ height: string; time: string }>,
  ): Promise<getblockstatsResult> {
  ...
  async getmempoolancestors(
    txid: string,
    verbose?: boolean,
  ): Promise<getmempoolancestorsResult> {
  ...
  async getmempooldescendants(
    txid: string,
    verbose?: boolean,
  ): Promise<getmempooldescendantsResult> {
  ...
  async scantxoutset(
    action: string,
    scanobjects?: Array<
      string | { desc: string; range: number | Array<number> }
    >,
  ...
  async generatetoaddress(
    ...
    address: string,
    maxtries?: number,
  ): Promise<generatetoaddressResult> {
  ...
  async generatetodescriptor(
    ...
    descriptor: string,
    maxtries?: number,
  ): Promise<generatetodescriptorResult> {
    return await this.request("generatetodescriptor", [
      num_blocks,
      descriptor,
      maxtries,
    ]);
  ...
  async getblocktemplate(
    template_request: { mode: string; capabilities: Array<string> },
  ): Promise<getblocktemplateResult> {
    return await this.request("getblocktemplate", [template_request]);
  }

  async getwork(data?: string): Promise<getworkResult> {
    return await this.request("getwork", [data]);
  }

  async getmininginfo(): Promise<getmininginfoResult> {
  ...
  async getnetworkhashps(
    nblocks?: number,
    height?: number,
  ): Promise<getnetworkhashpsResult> {
  ...
  async prioritisetransaction(
    ...
    fee_delta: number,
    dummy?: number,
  ): Promise<prioritisetransactionResult> {
  ...
  async submitheader(hexdata: string): Promise<submitheaderResult> {
